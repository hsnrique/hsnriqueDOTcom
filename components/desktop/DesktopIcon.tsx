...
export default function DesktopIcon({ label, icon = "file-text", imageSrc, onOpen, className }: DesktopIconProps) {
  ...
  return (
    ...
    >
      <div className="w-14 h-14 md:w-12 md:h-12 flex items-center justify-center overflow-hidden rounded-2xl md:rounded-lg bg-[rgba(0,255,65,0.08)] border border-[rgba(0,255,65,0.15)] shadow-[0_0_12px_rgba(0,255,65,0.06)]">
        {imageSrc ? (
          <Image src={imageSrc} alt="" width={56} height={56} unoptimized className="w-full h-full object-cover" />
        ) : (
          <>
